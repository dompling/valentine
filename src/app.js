...
* Hi，恒宝娃！
* 这么久了，还没和宝娃说过我的工作呢！
* 我是个前端工程师，俗称程序员，做的是和你访问的网页相关的东西。
* 如这个页面，就是个什么也没有的网页。
* 我的工作就是给这种空白的页面加点儿东西，访问其他项目提供的接口。
* 嗯，说起来手机和电脑还得区分一下。
* 你现在用的是应该是...${isPc ? '电脑' : '手机'}吧，哈哈猜猜我怎么知道的？
* 其实每次访问网页或者网站的时候，就已经被服务器记录了你访问的请求头信息了
* 我可以通过这些信息来判断你到底是用什么访问的，比如你现在访问的头信息就是
* ${navigator.userAgent}
*/
...
/*                          
* Ok，完成！
* 宝贝，七夕快乐！！世界因你，从此风得轻柔，雨得温暖，黑夜多一束亮光，凡尘也不再是惩罚。！
__     __                          ______          _   ______        
\\ \\   / /                         |___  /         (_) |  ____|       
 \\ \\_/ /   _   _    __ _   _ __      / /    __ _   _  | |__     _ __ 
  \\   /   | | | |  / _\` | | '_ \\    / /    / _\` | | | |  __|   | '__|
   | |    | |_| | | (_| | | | | |  / /__  | (_| | | | | |____  | |   
   |_|     \\__,_|  \\__,_| |_| |_| /_____|  \\__,_| |_| |______| |_|   
*/
